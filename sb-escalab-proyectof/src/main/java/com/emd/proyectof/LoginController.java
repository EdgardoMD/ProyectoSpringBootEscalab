...
import com.emd.proyectof.service.IResetTokenService;
import com.emd.proyectof.util.EmailUtil;
import com.emd.proyectof.util.Mail;
	...
	public ResponseEntity<Integer> enviarCorreo(@RequestBody String correo) {
		...
		try {
			...
			if (us != null && us.getIdUsuario() > 0) {
				...
				mail.setSubject("RESTABLECER CONTRASEÑA - PROYECTOF");
